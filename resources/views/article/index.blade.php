    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('article.create') }}"
                class="border border-green-500 hover:bg-green-500 hover:text-white px-4 py-2 rounded-md">CREATE</a>
                    ...
                    <table class="border-collapse table-auto w-full text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">Description
                                </th>
